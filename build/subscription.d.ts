...
export default class SubscriptionContract extends Deployed {
    ...
    approveAndDepositWithGasLimit(approvalAmount: string): Promise<TxResponse>;
    ...
    makeChargeWithGasLimit(u: string, d: Array<SubscriptionParameters>): Promise<TxResponse>;
